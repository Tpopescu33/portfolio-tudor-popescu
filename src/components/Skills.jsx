...
const Skills = () => {
    ...
    const infoSwift = "At UH one of my electives was umbiqutous computing, Which turned out to be iOS design. We where exposed to swiftUi and xcode. We made small apps throught the course that exposed us to all the different functionalities apple made available to design their apps, everything from creating simple card matching games to diving into apple maps and geotagging. By the end of the course I was able to combine my learned knowledge and create a fully functioning iOS application.";
    const nameGH = "Github";
